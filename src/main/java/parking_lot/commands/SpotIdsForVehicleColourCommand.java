...
import static parking_lot.enums.CommandEnum.SLOT_NUMBERS_FOR_CARS_WITH_COLOUR;
...
public class SpotIdsForVehicleColourCommand extends Command {
    ...
    public SpotIdsForVehicleColourCommand(ParkingLotService parkingLotService, String[] commandInputs) {
        ...
        expectedParameterInputs = String.format("Required: %s <color>", SLOT_NUMBERS_FOR_CARS_WITH_COLOUR);
    }
    ...
    public Response execute() throws ParkingLotException {
        ...
        return parkingLotService.getParkedSpotIdsForColourOfVehicle(colour);
    }
}
